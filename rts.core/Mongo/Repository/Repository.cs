...
namespace rts.core
{
    ...
    public abstract class Repository<T0, T> : Singleton<T0>, IRepository<T>
        where T : IEntity where T0 : new()
    {
        ...
        protected void GetCollection()
        {
            ...
            var connectionString = ConfigurationManager.AppSettings.Get("DbString");

            Collection = Database<T>.GetCollectionFromConnectionString(connectionString, repositoryName);
        }
